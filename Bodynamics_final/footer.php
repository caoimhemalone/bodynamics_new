<!-- Footer -->
	    <footer class="bg-dark" alt="footer">
	      <div class="container">
			...
			<!--<img src="images/positivessl_trust_seal_md_167x42.png">-->
	       
	       	<ul class="secure_img">
		       	 <li>
		       	 	<img class="ssl_cert" src="images/positivessl_trust_seal_md_167x42.png">
		       	 	<!--
	        ...
	        <p class="m-0 text-center text-white">Web Development & Design by <a href="https://www.key-vah.com" target="_blank">key-vah</a></p>
	        <p class="m-0 text-center text-white"> Bodynamics - Your Body, Your Life, Your Gym </p>
